...
const nhaGiaoPromo: PromoSectionProps = {
  ...
  pageColor: "#ddb4c3",
  itemTitlePrefix: "Gratitude Grace",
  items: [
    {
    ...
    },
    {
      ...
      alt: "Hộp quà trái cây dâu Hàn, kiwi vàng và sữa hạt",
...
const trungThuPromo: PromoSectionProps = {
  ...
  pageColor: "#d2bda2",
  itemTitlePrefix: "Fusion Moon",
  items: [
    {
      image: "/images/trung-thu-1.png",
      alt: "Hộp quà bánh trung thu trái cây sang trọng",
    ...
    },
    {
      ...
      alt: "Hộp quà bánh trung thu trái cây",
    ...
    },
    {
      ...
      alt: "Hộp quà bánh trung thu trái cây truyền thống",
    ...
    },
    {
      ...
      alt: "Hộp quà bánh trung thu trái cây cổ điển",
      description: "Hộp Quà Bánh Trung Thu Trái Cây Cổ Điển",
      discounted: 949000,
      savings: 150000,
    },
  ],
